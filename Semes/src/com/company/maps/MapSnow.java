...
public class MapSnow extends JPanel implements Runnable {
    ...
    private Wall wall = new Wall(150, 70, 1, "l", "ice");
    private Wall wall1 = new Wall(200, 150, 1, "l", "ice");
    private Wall wall2 = new Wall(150, 200, 2, "d", "ice");
    private Wall wall3 = new Wall(550, 0, 10, "d", "ice");
    private Wall wall4 = new Wall(150, 320, 1, "d", "ice");
    private Wall wall5 = new Wall(150, 390, 1, "d", "ice");
    private Wall wall6 = new Wall(150, 460, 1, "d", "ice");
    private Wall wall7 = new Wall(150, 530, 1, "d", "ice");
    private Wall wall8 = new Wall(330, 232, 1, "d", "ice");
    private Wall wall9 = new Wall(50, 0, 1, "d", "ice");
    private Wall wall10 = new Wall(0, 480, 1, "d", "ice");

    private EnemyFast enemyFast = new EnemyFast(0, 0);
    private EnemyFast enemyFast1 = new EnemyFast(610, 0);
    private EnemyFast enemyFast2 = new EnemyFast(660, 0);
    private EnemyFast enemyFast3 = new EnemyFast(710, 0);

    private EnemyLeft enemyLeft = new EnemyLeft(500, 0);
    private EnemyLeft enemyLeft1 = new EnemyLeft(500, 48);
    private EnemyLeft enemyLeft2 = new EnemyLeft(500, 96);
    private EnemyLeft enemyLeft3 = new EnemyLeft(500, 144);
    private EnemyLeft enemyLeft4 = new EnemyLeft(500, 192);
    private EnemyLeft enemyLeft5 = new EnemyLeft(500, 240);
    private EnemyLeft enemyLeft6 = new EnemyLeft(500, 288);
    private EnemyLeft enemyLeft7 = new EnemyLeft(500, 336);
    private EnemyLeft enemyLeft8 = new EnemyLeft(500, 384);
    private EnemyLeft enemyLeft9 = new EnemyLeft(500, 432);
    ...
    private final ArrayList<EnemyLeft> enemies2 = new ArrayList<EnemyLeft>();
     ...
     */
    public MapSnow(JFrame frame, Player player) {
        ...
        this.backgroundImage = new ImageIcon("./pics/floor/ice_floor.png").getImage();
        ...
        this.enemies2.add(this.enemyLeft7);
        this.enemies2.add(this.enemyLeft8);
        this.enemies2.add(this.enemyLeft9);
    ...
    private ActionListener returnToMenuHandler() {
        ...
        return new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                MainMenu mainMenu = new MainMenu(window, MapSnow.this.player);
                ...
                MapSnow.this.mainFrame.dispose();
            }
        };
    }
